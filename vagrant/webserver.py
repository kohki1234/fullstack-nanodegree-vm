		...
		try:
			if self.path.endswith('/edit'):
				...
				if myRestaurantQuery != []:
					...
					output += "</h1>"
					output += "<form method='POST' enctype='multipart/form-data' action='/restaurant/%s/new'>" % restaurantIDPath
					output += '<input name="restaurantname" type="text" ><input type="submit" value="Rename">'
					output += "</form>"
					output += "</html></body>"
